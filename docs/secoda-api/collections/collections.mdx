...
The **Endpoint** field for self-hosted instances is `<host_url>/api/v1/collection/collections/`For example, https://secoda.company.com/api/v1/collection/collections/
