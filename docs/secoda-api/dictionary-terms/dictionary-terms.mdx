...
The **Endpoint** field for self-hosted instances is `<host_url>/api/v1/dictionary/terms/`For example, https://secoda.company.com/api/v1/dictionary/terms/
...
```json Sample Response
{
  ...
  "results": [
    ...
    },
    {
      ...
      "tags": ["39x8pqpw0pi92wh6", "2w1dot2hn6ksmskj"],
      "related_tables": [],
      "related_dashboards": [],
      "badges": [
        {
