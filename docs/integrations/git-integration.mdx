...
1. 1.  
Open this [link on](https://github.com/settings/tokens) Github
...
1. 1.  
Open your Secoda integrations page

2. 2.  
Click on "New Integration" on the top left

3. 3.  
Select git from the list of integrations

4. 4.  
Input your Git credentials from step 2 for “Git Username” and “Git Password”

5. 5.  
Click on "Test Connection" to save the integration.

6. 6.  
Once integration is created, click on “Run Extraction” from history tab to run your first extraction
