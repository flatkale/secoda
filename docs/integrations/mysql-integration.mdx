...
To create a new user, you’ll need to log into the MySQL database directly and
...
When connecting to MySQL in Secoda, use the username/password you’ve created
