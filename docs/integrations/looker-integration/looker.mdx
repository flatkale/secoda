...
1. 1.  
Retrieve your Looker Client ID and Client Secret

2. 2.  
Retrieve your Looker host

3. 3.  
Connect Looker to Secoda

4. 4.  
Looker Lineage (Optional)

#### Retrieve you Looker Client ID and Client Secret
...
2. 2.  
Search for and select Looker

3. 3.  
Enter your Looker Client ID, Client Secret, and host you retrieved above

4. 4.  
Click 'Connect'

#### Connect LookML repo to Secoda (Optional)
...
![](https://3544070331-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2FqxbfBjqa19PllrcxgKxO%2Fuploads%2FVZTejaJoTdmesv6ui4X6%2Fimage.png?alt=media&token=8957f843-5c46-46d5-a715-c5f43bb8f6ae)
...
_Note: You_ **_DO NOT_** _need to provide write access_
...
_Note: You_ **_DO NOT_** _need to start the extraction process if you would rather wait until the next scheduled extraction._