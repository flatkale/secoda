...
1. 1.  
Generate an API Key and an API Secret on Fivetran

2. 2.  
Connect Fivetran to Secoda with your API Key and API Secret

### Generate an API Key

1. 1.  
Login to Fivetran and head to the Settings/API Config section.

2. 2.  
Generate an API Key and API Secret (make sure to copy the key and secret).
