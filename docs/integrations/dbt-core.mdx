...
1. Create a blank dbt core integration by going to <https://app.secoda.co/integrations/new> and selecting the "dbt Core" integration and then click "Test Connection". And run the initial extraction. This extraction will fail, but that's intended.
