...
description: "This page walks through the Secoda and dbt Core integration that Secoda supports"
---
...
1. 1.  
Navigate to <https://app.secoda.co/integrations/new>

2. 2.  
Click "dbt Core"

3. 3.  
Select your manifest.json file using the file selector
...
3. 3.  
Add the credentials that you've saved from AWS  
   * Region  
   * Bucket Name  
   * Access Key ID  
   * Secret Access Key
...
3. 3.  
Follow the example in our [API docs](https://docs.secoda.co/secoda-api/dbt-integration) to upload a manifest.json file using the integration ID you created.