...
GRANT CONNECT ON DATABASE <database\_name> TO secoda;


\-- Complete this query for any schemas you would like Secoda to extract from 

GRANT USAGE ON SCHEMA <schema\_name> TO secoda;

GRANT SELECT ON ALL TABLES IN SCHEMA <schema\_name> TO secoda;

ALTER DEFAULT PRIVILEGES IN SCHEMA <schema\_name>
