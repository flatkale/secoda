...
To create a new user, you’ll need to log into the Postgres database directly and
...
When connecting to Postgres in Secoda, use the username/password you’ve created
here instead of your admin account.

#### Connect Postgres to Secoda
...
Allow Secoda to read into your Postgres database using`35.175.75.15/32`

[Postgres Integration](/integrations/postgres-integration)
