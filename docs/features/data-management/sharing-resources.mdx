...
description: "Secoda is built to be super collaborative, so there's a number of ways to share the content you create with other people."
---

## **How to share data using Secoda**
