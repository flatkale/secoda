...
description: "To export data descriptions out of Secoda, you can go to Settings → Data → Export data. Below is the screenshot for the settings:"
---

## **How to export data to Secoda**
